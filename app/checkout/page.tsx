    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-white relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        >
          ...
          <div className="bg-white/85 backdrop-blur-md rounded-2xl shadow-xl p-8 mb-8 border border-white/30">
          ...
          <div className="bg-white/85 backdrop-blur-md rounded-2xl shadow-xl p-8 mb-8 border border-white/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                ...
                className="bg-white/85 backdrop-blur-md rounded-xl p-6 shadow-lg border border-white/30 flex flex-col"
              >
                <div className="mb-4">
          ...
          <motion.div
            ...
            className="bg-white/85 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/30"
          >
