      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-12">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-[#0047c7]/10 to-[#e5107a]/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-3 h-3 bg-[#0047c7] rounded-full" />
              </div>
